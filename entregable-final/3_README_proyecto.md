...
└── docs/                               # Documentación académica
    ├── memoria_final_predictor_ocupacion_barcelona.docx
    ├── 1rCorte_optimizador_precios_barcelona.docx.pdf
    ├── 2do_corte_herramientas_implementacion_documentacion.docx
    ├── entrega1_predictor_ocupacion_barcelona.docx
    ├── defensa_explicacion_completa.{md,pdf}
    ├── defensa_guion_conciso.{md,pdf}
    ├── defensa_guion_rapido.{md,pdf}
    └── defensa_apuntes_detallados.{md,pdf}
```
